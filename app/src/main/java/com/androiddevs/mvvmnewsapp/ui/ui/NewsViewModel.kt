...
import com.androiddevs.mvvmnewsapp.ui.NewsAplication
...
//        breakingNews.postValue(Resource.Loading()) -> before replace
        safeBreakingNewsCall(countryCode)

    }

    fun searchNews(searchQuery: String) = viewModelScope.launch {
        /*searchNews.postValue(Resource.Loading()) -> before Replace
